...
### 🤖 [AI 日报聚合 Agent (AI Daily)](https://github.com/brain898/ai-daily)
一个全自动的内容聚合 Agent，每天从 GitHub、HackerNews、Reddit 和 X(Twitter) 等平台抓取最新的 AI 资讯，使用大模型进行要点总结，并自动生成结构化的 Markdown 报告。
- **技术栈:** Python, 大模型 API, 网页爬虫, GitHub Actions
